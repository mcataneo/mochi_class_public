...
/* @endcond */
  ...
  double range_braiding_close_to_2_smg; /**< when the braiding is close to 2 (decided by this range) compute h^\prime from the trace rather than the Einstein 00 (or regularize it) */
